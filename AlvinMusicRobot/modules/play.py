...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/eb88ad83fbaabbc57cd4d.jpg"
        ...
        try:
            ...
            try:    
                ...
                for i in range(len(dur_arr)-1, -1, -1):
                    ...
                    secmul *= 60
                if (dur / 60) > DURATION_LIMIT:
                     await lel.edit(f"❌ Video lebih lama dari {DURATION_LIMIT} menit tidak diizinkan untuk bermain!")
                     return
            except:
                pass
            dlurl=url
    ...
    if chat_id in callsmusic.active_chats:
        ...
        await message.reply_photo(
            photo="final.png",
            caption=f"#⃣ lagu request anda <b>queued</b> di posisi {position}!",
        ...
        await message.reply_photo(
            photo="final.png",
            reply_markup=keyboard,
            caption="▶️ <b>Playing</b> lagu yang di request oleh {} via Youtube Music 😎".format(
...
async def jiosaavn(client: Client, message_: Message):
    ...
    if chat_id in callsmusic.active_chats:
        ...
        m = await client.send_photo(
            ...
            reply_markup=keyboard,
            photo="final.png",
            caption=f"✯{bn}✯=#️⃣ Queued di posisi ke {position}",
        )
        ...
        try:
            ...
            res.edit("Group call tidak terhubung karena saya tidak dapat bergabung")
            return
    ...
    m = await client.send_photo(
        ...
        reply_markup=keyboard,
        photo="final.png",
        caption=f"memutar {sname} Via Jiosaavn",
    )
    os.remove("final.png")
...
async def lol_cb(b, cb):
    ...
    if cb.from_user.id != useer_id:
        ...
        return
    await cb.message.edit("Tunggu sebentar....sedang memutar")
    x=int(x)
    try:
    ...
    if chat_id in callsmusic.active_chats:
        ...
        await b.send_photo(chat_id,
            photo="final.png",
            caption=f"#⃣  request lagu oleh {r_by.mention} <b>queued</b> di posisi ke {position}!",
            reply_markup=keyboard,
        )
        os.remove("final.png")
        ...
        await b.send_photo(chat_id,
            photo="final.png",
            reply_markup=keyboard,
            caption=f"▶️ <b>Playing</b> lagu yang di request oleh {r_by.mention} via Youtube Music 😎",
        )
        os.remove("final.png")
